...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(VM.object,"MILP Object Based","MILP Object Based");
	localDefaultCategoryDataset.addValue(VM.relay,"MILP Relay Based","MILP Relay Based");
	localDefaultCategoryDataset.addValue(VM.hybrid,"MILP Hybrid Based","MILP Hybrid Based");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Technique Name", "Execution Time", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
